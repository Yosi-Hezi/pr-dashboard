...
DEFAULT_DISPLAY: dict = {
    ...
    "truncation_suffix": "..",
    "row_rules": [
        {"conditions": {"mergeStatus": "conflicts"}, "color": "#4a2d2d", "italic": True, "description": "Recommended: resolve merge conflicts before continuing"},
        {"conditions": {"role": "author", "hasActiveComments": True}, "color": "#4a3d1a", "bold": True, "description": "Recommended: address active review comments"},
        {"conditions": {"role": "reviewer", "myVote": "NoVote", "isRequiredReviewer": True}, "color": "#3d3a1a", "description": "Recommended: review and vote — you are a required reviewer"},
        {"conditions": {"role": "reviewer", "myVote": "WaitingForAuthor", "allCommentsResolved": True}, "color": "#2d3a4a", "italic": True, "description": "Recommended: re-review — author has resolved all comments"},
